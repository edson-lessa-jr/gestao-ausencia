    ...
    <Dialog open={importOpen} onClose={() => !importing && setImportOpen(false)} fullWidth maxWidth="lg">
      ...
      <DialogContent>
        <Stack spacing={2} mt={.5}>
          ...
          <Typography variant="body2" color="text.secondary">Colunas obrigatórias: Email, Nome, Data de Início, Data Final, Número de dias úteis e Saldo de férias atual no último PaySlip. Id e Hora de início são recomendadas para identificar o registro mais recente.</Typography>
          {preview && <>
